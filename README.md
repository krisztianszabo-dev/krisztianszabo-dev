...
### Mérnökinformatikus hallgató | Python & SQL Backend irányultság

Végzős mérnökinformatikus hallgató vagyok (6. félév), aki a technológiai alapokat az egyetemen, a gyakorlati tudást pedig saját projekteken és online kurzusokon (pl. Udemy) keresztül sajátítja el. Hiszek abban, hogy a jó kód nemcsak működik, hanem olvasható és fenntartható is.
...
## 📈 Céljaim az utolsó félévre:

- A szakdolgozatom Python alapú backendjének tökéletesítése.
- A Python mélyebb összefüggéseinek elsajátítása (Advanced Decorators, Generators).
- Olyan junior pozíció megtalálása, ahol az SQL és Python tudásomat kamatoztathatom.

📫 **Elérhetőség:** [LinkedIn profilom hamarosan...]
